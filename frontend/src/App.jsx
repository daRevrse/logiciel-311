...
const adminTitles = {
  ...
  '/admin/municipality/settings': 'Paramètres de la municipalité',
};
    ...
    <Router>
      <AuthProvider>
        ...
        <Routes>
          ...
          <Route path="/agent/interventions/:id" element={<ProtectedRoute agentOnly><AgentLayout><InterventionDetail /></AgentLayout></ProtectedRoute>} />
