...
const AdminLogin = () => {
  ...
  // Charger le contexte mairie depuis le slug
  useEffect(() => {
    if (!municipalitySlug) {
      setMunicipality(null);
      return;
    }
    api.get(`/public/municipalities/by-slug/${municipalitySlug}`)
      .then((res) => setMunicipality(res.data.data))
      .catch(() => {
        setMunicipality(null);
        setError('Lien mairie invalide');
      });
  }, [municipalitySlug]);
